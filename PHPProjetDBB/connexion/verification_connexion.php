...
function check_log_user($droit_user,$num_page,$num_commande)
{
...
else
{
			...
			echo "vous devez d'abord vous connectez<br/>";
			echo "<a href=\"http://www-etu.iut-bm.univ-fcomte.fr/bdd3b1/rendu_projet/connexion/page.php\">Se connecter</a>";
