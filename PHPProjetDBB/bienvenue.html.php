...
?>
	<script language="JavaScript">
		setTimeout("window.location.href='./'", 2000); // delai en millisecondes, ici 5 secondes
	</script>
	
	<p id="bienvenue">
		<i>Chargement en cours...</i> <img
			src="/include/css/img/chargement.gif" alt="chargement" />
	</p>
