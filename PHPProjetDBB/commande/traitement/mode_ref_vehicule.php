...
echo("<td><label id=\"titre\">".$data['code_mode_ref_vehicule']."</label><input type=\"hidden\" id=\"mode_ref\" name=\"mode_ref\" value=\"".$data['code_mode_ref_vehicule']."\"/><input type=\"text\" id=\"ref_vehicule\" name=\"ref_vehicule\" value=\"\" /> </td>");
}
?>    
