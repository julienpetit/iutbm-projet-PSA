...
if (isset($_GET['num_commande'])){//si on a bien un numéro de commande transmis
	...
	if ($donnee['motif_fermeture'] != NULL)     //si le motif de fermeture existe alors elle est déjà fermée
		echo '<script event=onload>toMenu("La commande n\'a pas pu être annulée : elle est déjà fermée.");</script>';
