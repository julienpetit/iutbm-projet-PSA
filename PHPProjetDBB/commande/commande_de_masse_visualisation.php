...
<table id="derniere">
	...
	<tr>
		...
		<td><?php echo("<input readonly value=".$data['libelle_entite'].">"); ?>
		</td>
		<?php
		if(!empty($data['motif_fermeture']))
		{
	...
	<tr>
		...
		<td id="resultat"><?php echo("<input readonly value=".$data['code_imputation'].">"); ?>
		</td>
	</tr>
...
<?php   }   ?>
<input
	type="submit" id="val" action="" value="détails commande">
<input type="reset"
	id="anu" value="Remettre a zero">
<input
	type="reset" id="anu" value="Accueil"
