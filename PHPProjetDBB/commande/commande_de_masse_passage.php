        ...
        <table>
                ...
                <table id="masse">
                    <caption id="titre1"> Commande </caption>
	                    ...
	                    <tr>
                            <td> <input type = "button" name = "+" value="+" id="+" onclick="afficher();" style="width:50px;"  > </td>
                            <td> <input type="text" name="ReferenceCM_pp1" id="ReferenceCM_pp1" value="" onchange="verifierRef('ReferenceCM_pp1')" /> </td>
                            <td> <input type="text" name="DesignationCM_pp1" id="DesignationCM_pp1" value="" style="width:500px;"/> </td>
                        ...
                        <tr>
			                 <td ></td>
                            <td> <input type="text" name="ReferenceCM_pp2" id="ReferenceCM_pp2" value="" style="display: none;" onchange="verifierRef('ReferenceCM_pp2')" /> </td>
                            <td> <input type="text" name="DesignationCM_pp2" id="DesignationCM_pp2" value="" style="display: none;width:500px;"/> </td>
                            <td> <input type="text" name="QuantiteCM_pp2" id="QuantiteCM_pp2"  value="" style="display: none;" onkeyup="verifierQuant('QuantiteCM_pp2')" onchange="alertQuant('QuantiteCM_pp2')" /> </td>
                            <td> <input type="text" name="PotentielCM_pp2" id="PotentielCM_pp2" value="" style="display: none;"/> </td>
	                    ...
	                    <tr>
                            <td> <input type = 'button' name = 'plus' value='+' id = 'plus' onclick="afficher2();" style="width:50px;"  /> </td>
		                    <td> <input type="text" name="ReferenceCM_pe1" id="ReferenceCM_pe1"  value=""  onchange="verifierRef('ReferenceCM_pe1')" /> </td>
                            <td> <input type="text" name="DesignationCM_pe1" id="DesignationCM_pe1"  value="" style="width:500px;"  /> </td>
                            <td> <input type="text" name="QuantiteCM_pe1" id="QuantiteCM_pe1" value="" onkeyup="verifierQuant('QuantiteCM_pe1')" onchange="alertQuant('QuantiteCM_pe1')" /> </td>
                            <td>  </td>
                            
	                    </tr>
                        <tr>			   
			  
			    			<td> <input type = 'button' name = 'plus2' value='+' id = 'plus2' onclick = "afficher3();" style="display: none;width:50px;disabled:false;"></td> 
			                <td> <input type="text" name="ReferenceCM_pe2" id="ReferenceCM_pe2"  value=""style="display: none;"  onchange="verifierRef('ReferenceCM_pe2')"/> </td>
                            <td> <input type="text" name="DesignationCM_pe2" id="DesignationCM_pe2"  value="" style="display: none;width:500px;"/> </td>
                            <td> <input type="text" name="QuantiteCM_pe2" id="QuantiteCM_pe2" value="" style="display: none;" onkeyup="verifierQuant('QuantiteCM_pe2')" onchange="alertQuant('QuantiteCM_pe2')"/> </td>
                            <td>  </td>
 			            ...
 			            <tr>			   
			                <td> </td>
                            <td> <input type="text" name="ReferenceCM_pe3" id="ReferenceCM_pe3"  value=""style="display: none;" onchange="verifierRef('ReferenceCM_pe3')"/> </td>
                            <td> <input type="text" name="DesignationCM_pe3" id="DesignationCM_pe3"  value="" style="display: none;width:500px;"/> </td>
                            <td> <input type="text" name="QuantiteCM_pe3" id="QuantiteCM_pe3" value="" style="display: none;" onkeyup="verifierQuant('QuantiteCM_pe3')" onchange="alertQuant('QuantiteCM_pe3')"/> </td>
                            <td>  </td>
            ...
            <table id="derniere">
	                    ...
	                    <tr>
                            <th> <p id="sous-titre">Entit&eacute;</p> </th>
                            <td>
	                    ...
	                    <tr>
                            <th> <p id="sous-titre">CA imput&eacute;</p> </th>
                            <td> <div id="resultat"><input  type="text" name="CaImputeCM" id="CaImputeCM" value="" /> </div> </td>
	                    </tr>	 
