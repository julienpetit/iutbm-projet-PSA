...
?>           
            <table id="derniere">
	                    ...
	                    <tr>
                            ...
                            <td>
                                <?php echo("<input value=".$data['libelle_entite'].">"); ?>
                            </td>
                           
                           
                            <td rowspan="2"> <textarea rows="3" cols="30" name="MotifFermetureCM" id="MotifFermetureCM" style="margin-left: 250px;">Veuillez remplir le motif de fermeture de la commande.</textarea> </td>
	                    ...
	                    <tr>
                            ...
                            <td id="resultat">
                                <?php echo("<input value=".$data['code_imputation'].">"); ?>
                            </td>
	                    </tr>	 
